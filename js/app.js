...
"use strict"
let competenciesFirstPlay = document.querySelector('#competenciesFirstPlay');
let competenciesFirstVideo = document.querySelector('#competenciesFirstVideo');
let competenciesSecondPlay = document.querySelector('#competenciesSecondPlay');
let competenciesSecondVideo = document.querySelector('#competenciesSecondVideo');

if (competenciesFirstPlay) {
	competenciesFirstPlay.addEventListener("click", function (e) {
		competenciesFirstVideo.play();
		competenciesFirstPlay.classList.add("_active");
	});
}
if (competenciesSecondPlay) {
	competenciesSecondPlay.addEventListener("click", function (e) {
		competenciesSecondVideo.play();
		competenciesSecondPlay.classList.add("_active");
	});
}
